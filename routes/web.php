...
})->name('admin.user_add')->middleware(['auth', 'userIsAdmin']);

Route::post('/dashboard/admin/user/add',[UserController::class, 'addNewUser'])->name('admin.user_add')->middleware(['auth', 'userIsAdmin']);
