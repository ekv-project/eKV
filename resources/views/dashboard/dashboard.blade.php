...
@section('content')
    <div class="container-fluid mt-1 w-100 h-100 d-flex flex-column align-items-center">
        <div class="row rounded-3 shadow-lg mt-5 w-100 d-flex flex-column align-items-center justify-content-center bg-light">
            <h1 class="fs-2 text-center my-3">Navigasi</h1>
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 mt-4 mb-5">
