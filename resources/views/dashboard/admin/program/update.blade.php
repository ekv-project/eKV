        ...
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-12 col-lg-10">
                <form action="" method="post" class="mt-3 mb-5">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="department_name" id="department_name" class="form-control" placeholder="department_name" value="@php if(old('department_name') !== null){echo old('department_name');}elseif(isset($program->department_name)){echo ucwords($program->department_name);}else{echo NULL;} @endphp">
